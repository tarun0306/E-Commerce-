...
export class CartComponent implements OnInit, OnDestroy, AfterContentChecked {
    ...
    ngAfterContentChecked() {
        ...
        //     this.whole_string=this.coupon;
        //     this.split_string = this.whole_string.split(/(\d+)/)
        //    console.log("Text:" + this.split_string[0] + " & Number:" + this.split_string[1])
        //    this.newTotal= this.total - this.total*(parseInt(this.split_string[1])/100);
    }
 ...
 sCoupon(): any {
    ...
    //         console.log("Text:" + this.split_string[0] + " & Number:" + this.split_string[1])
            ...
            this.split_string=this.selectedCoupon.split("-");
            this.newTotal=this.total-this.total*(parseInt(this.split_string[1])/100);
            console.log(this.selectedCoupon,this.split_string[1]);
            return this.num.toString(this.newTotal);
